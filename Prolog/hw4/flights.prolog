...
%connecting
route(Departing,Arriving,Visited,DepartureTime,ArrivalTime,Flights,TotalCost):-
    flight(Departing,Connecting,DepartureTime,ConnectingArrivalTime,FirstCost),
    \+member(Connecting,Visited),
    append(Visited,[Departing,Connecting],NewVisited),
    route(Connecting,Arriving,NewVisited,NextConnectingTime,ArrivalTime,NextFlights,NextCost),
    ConnectingArrivalTime @< NextConnectingTime, 
    Flights = [Departing|NextFlights],
    TotalCost is FirstCost + NextCost.
